...
//    public Timeout globalTimeout = Timeout.seconds(30);
    ...
    public void get_lines_for_keys_3_keys() throws Exception{
        ...
        assertEquals("Benny",values2.get(0).get("Reviewer").get());
        assertEquals("Benny",values2.get(1).get("Reviewer").get());
        assertEquals("Nadav",values2.get(2).get("Reviewer").get());
        assertEquals("8",values2.get(0).get("Score").get());
        assertEquals("9",values2.get(1).get("Score").get());
        assertEquals("8",values2.get(2).get("Score").get());
        assertEquals("a",values2.get(0).get("Value").get());
        assertEquals("d",values2.get(1).get("Value").get());
        assertEquals("a",values2.get(2).get("Value").get());
    ...
    public void get_lines_for_keys_2_keys() throws Exception{
        ...
        assertEquals(values.get(0).get("Book").get(), "Bla");
        assertEquals(values.get(1).get("Book").get(), "Harry");
        assertEquals(values.get(0).get("Score").get(), "8");
        assertEquals(values.get(1).get("Score").get(), "8");
    ...
    public void get_lines_for_keys_2_keys_multipels() throws Exception{
        ...
        assertEquals(values.get(0).get("Book").get(), "Bla");
        assertEquals(values.get(1).get("Book").get(), "Harry");
        assertEquals(values.get(2).get("Book").get(), "Harry");
        assertEquals(values.get(0).get("Score").get(), "8");
        assertEquals(values.get(1).get("Score").get(), "9");
        assertEquals(values.get(2).get("Score").get(), "8");
